...
async function getFare(pickup, destination) {
    ...
    if (!distanceTime || !distanceTime.distance || !distanceTime.duration) {
        throw new Error("Invalid distance or duration data from mapsService");
    }
...
module.exports.createRide = async ({ user, pickup, destination, vehicleType }) => {
    ...
    if (!fare || !fare[vehicleType]) {
        console.error("Error: Fare data is missing or invalid", { fare, vehicleType });
        throw new Error("Invalid fare data for vehicle type.");
    }
